...
```{r, echo=F,cache=T, fig.cap='Figure 2. Model run to equilibrium over a range of harvest parameters, no stocking. Top panel shows equilibrium abundances for the range of harvests when species 1 is initially dominant. Bottom panel shows equilibrium abundances for the range of harvests when species 2 is initially dominant.'}
...
```{r, echo=FALSE, cache=T, fig.dim=c(7,7), fig.cap="Fig X. Effect of hysteresis on either maintaining sp1 dominance (A &C) or flipping to a state where sp 1 dominates (B &D). This is described for systems with and without hysteresis. Green = sp1 equilibrium abundance higher than sp2, red = sp2 > sp1"}
##### HEATMAPS #####
