...
```
*Here, I think we should list all the simulations we ran and say why - then just show the different ones in the results*
### Simulations: 
*Do these make sense? I think this covers what we discussed figure-wise, but am open to different ideas*
Influence of management (control on harvest) over time   
Timing of management intervention for stable state maintenance  
- Running the model to equilibrium and then look at management timing   
Influence of stocking on system dynamics (w/ and w/out hysteresis)  
What if we put both together?   
slow change in system - how can management help?   
