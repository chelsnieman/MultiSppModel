...
vz+geom_tile(aes(x=dfT$X, y=dfT$Y, fill=dfT$diff))+
...
```{r, echo=F, fig.align="center",fig.cap="Figure 4. Delaying a transitions. Slow moving variable 'h'represents changing habitat availability which will inevitably flip system from sp1 dominated to sp2 (panel A). The flip in system state can be delayed through either stocking of the desired species (panel B), harvest of it's competitior (panel C), or both (panel D)."}
...
text(x=375, y=1500, labels = "Stocking sp1")
...
text(x=375, y=1500, labels = "Harvesting sp2")
